...
<div class="mx-auto max-w-lg space-y-6">
	<div class="space-y-2">
		<h2 class="text-lg font-semibold">Silver Assets</h2>
	...
	{#if silverItems.length === 0}
		<div class="border-border flex flex-col items-center gap-3 rounded-md border border-dashed p-8 text-center">
			<p class="text-muted-foreground text-xs">No silver items added yet.</p>
	...
	{#if totalValue > 0}
		<div class="border-border rounded-md border p-3 text-center">
			<p class="text-muted-foreground text-[10px] uppercase tracking-wide">Total Silver Value</p>
